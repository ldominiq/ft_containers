//
// Created by Lucas on 08-Dec-22.
//

#ifndef FT_BIDIRECTIONAL_MAP_ITERATOR_HPP
#define FT_BIDIRECTIONAL_MAP_ITERATOR_HPP
...
namespace ft {
    ...
    struct bidirectional_map_iterator {
        ...
        bidirectional_map_iterator(const bidirectional_map_iterator<Key, T, false> &copy): _ptr(copy._ptr) {}

        bidirectional_map_iterator(const bidirectional_map_iterator<Key, T, true> &copy): _ptr(copy._ptr) {}
...
#endif //FT_BIDIRECTIONAL_MAP_ITERATOR_HPP
